...
Bostonin kaupungin käyttämästä algoritmista \cite{abdusön03}.
...
Abdulkadiroğlu ja Sönmez esittelevät \emph{top trading cycles
  -algoritmin} \cite{abdusön03}. Abdulkadiroğlu ja Sönmez toteavat sen
...
luonnehtivatkin vakautta kateuden kautta \cite{abdusön03}. Epävakaassa
...
\enlargethispage{\baselineskip} Bostonin mekanismi ei ole
strategiankestävä \cite{abdusön03}. Tämä on helppo havaita esimerkistä
jossa $O = \{o_1, o_2, o_3\}$, $H = \{h_1, h_2, h_3\}$ ja toimijoiden
mieltymykset taulukon \ref{boston_strategia} mukaiset.
...
Top trading cycles on strategiankestävä \cite{abdusön03}.
