...
oikeutetusti kateellinen jollekin toiselle hakijalle hänen saamastaan
...
Taulukon \ref{roth_optimaalisuus} esimerkissä ainut vakaa sijoittelu
on $\{(h_1, o_1), (h_2, o_2), (h_3, o_3)\}$, mutta se ei ole
